...
var b=[];jQuery("input[name='form.joinable_groups']").each(function(c,e){var d=jQuery("span[id=checkboxgroup-form-joinable_groups-"+c+"]");
if(jQuery(e).is(":checked")){a.push(d)}else{b.push(d)}});jQuery(b).each(function(c,d){d.detach();
